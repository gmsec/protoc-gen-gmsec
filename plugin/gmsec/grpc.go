...
const (
	...
	serverPackage  = protogen.GoImportPath("github.com/gmsec/micro/server") // add by xxj
	clientPackage  = protogen.GoImportPath("github.com/gmsec/micro/client") // add by xxj
	gmsecPackage   = protogen.GoImportPath("github.com/gmsec/micro")        // add by xxj
...
func GenerateFile(gen *protogen.Plugin, file *protogen.File) *protogen.GeneratedFile {
	...
	filename := file.GeneratedFilenamePrefix + ".pb.gmsec.go"
...
func GenerateFileContent(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile) {
	...
	g.P("var _ ", serverPackage.Ident("Server")) // add by xxj
	g.P("var _ ", clientPackage.Ident("Client")) // add by xxj
	g.P("var _ ", gmsecPackage.Ident("Service"))
	g.P()
...
func genService(gen *protogen.Plugin, file *protogen.File, g *protogen.GeneratedFile, service *protogen.Service) {
	...
	g.P("cc ", clientPackage.Ident("Client")) // change by xxj
	g.P("}")
	g.P()

	// add by xxj
	g.P("// Get", service.GoName, "Name get client name(package.class)")
	g.P("func Get", service.GoName, "Name() string {")
	g.P("return ", strconv.Quote(string(service.Desc.FullName())))
	g.P("}")
	g.P()

	g.P("// Get", clientName, " get client by clientname")
	g.P("func Get", clientName, " () ", clientName, " {") // change by xxj
	g.P("cc := micro.GetClient(Get", service.GoName, "Name())")
	g.P("return &", unexport(clientName), "{cc}")
	g.P("}")
	g.P()

	g.P("// Get", clientName, "ByName get client by custom name")
	g.P("func Get", clientName, "ByName (name string) ", clientName, " {") // change by xxj
	g.P("cc := micro.GetClient(name)")
	g.P("return &", unexport(clientName), "{cc}")
	g.P("}")
	g.P()
	...
	g.P("func New", clientName, " (cc ", clientPackage.Ident("Client"), ") ", clientName, " {") // change by xxj
	g.P("return &", unexport(clientName), "{cc}")
	g.P("}")
	g.P()
	...
	g.P("func Register", service.GoName, "Server(s ", serverPackage.Ident("Server"), ", srv ", serverType, ") {") // change by xxj
	g.P("s.GetServer().RegisterService(&", serviceDescVar, `, srv)`)
	g.P("}")
	g.P()
